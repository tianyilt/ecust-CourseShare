========================================================================
                    CUSTOM APPWIZARD: OpenGL多文档
========================================================================


AppWizard has created a OpenGL多文档 DLL for you.  This DLL is the starting point
...
you build OpenGL多文档.awx, it will automatically be copied to your Template
...
OpenGL多文档Aw.h, OpenGL多文档Aw.cpp - the CCustomAppWiz class
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into OpenGL多文档.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "E:\郑平泰之文稿\《OpenGL高级编程与可视化系统开发（高级编程篇）》\第2章  OpenGL编程基础\MyMDOpenGL\MyMDOpenGL.dsp".
...
off of the project "E:\郑平泰之文稿\《OpenGL高级编程与可视化系统开发（高级编程篇）》\第2章  OpenGL编程基础\MyMDOpenGL\MyMDOpenGL.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named OpenGL多文档.pch and a precompiled types file named StdAfx.obj.
