...
void C$$Safe_root$$View::OnDestroy() 
{
	CView::OnDestroy();
...
void C$$Safe_root$$View::OnTimer(UINT nIDEvent) 
{
...
//	                  设置逻辑调色板
//////////////////////////////////////////////////////////////////////
void C$$Safe_root$$View::SetLogicalPalette(void)
{
    struct
    {
        WORD Version;
...
//						初始化openGL场景
//////////////////////////////////////////////////////////
BOOL C$$Safe_root$$View::InitializeOpenGL(CDC* pDC)
{
	m_pDC = pDC;
	SetupPixelFormat();
	//生成绘制描述表
...
//						设置像素格式
//////////////////////////////////////////////////////////
BOOL C$$Safe_root$$View::SetupPixelFormat()
{
...
//						场景绘制与渲染
//////////////////////////////////////////////////////////
BOOL C$$Safe_root$$View::RenderScene() 
{
